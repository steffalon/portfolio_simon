...
if(isset($_POST["submitting"]))
  {
    if(empty($_POST["username"]))
    {
      ...
      if(mysqli_num_rows($result) > 0)
      {
        ...
        if ($isbanned == 'banned') {
          $error = "Recovery is not possible. This account is banned from the CarTek website!";
        } else {
          $uid = $row['uid'];
          ...
          $to = $row['email'];
          $subject = "CarTek password recovery";
          $msg = '<html><body>';
          $msg .= "<p>Hello " . $row['username'] . ",<br>We have received your password recovery request. Here is your password recovery request link: <a href='https://steffalon.com/bewijzenmap/bap/cartek/recovery.php?rcode=" . $setcode . "&id=" . $row['uid'] ."'>https://steffalon.com/bewijzenmap/bap/cartek/recovery.php</a><br><br>
          This recovery code will be invalid after around 24 hours if its not been used. We do this for safety reasons.<br><br>- CarTek Team</p>";
          $msg .= '</html></body>';
          $headers = "From: " . "Recovery@steffalon.com" . "\r\n";
