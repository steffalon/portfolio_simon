    ...
    if(empty($_POST["email"]) || empty($_POST["username"]) || empty($_POST["password"]))
        ...
        // Create account.
            ...
            if (mysqli_query($mysqli, $sql)) {
                ...
                $to = $email;
                $subject = "SteffGram account validator";
                $msg = '<html><body>';
                $msg .= "<p>Hello " . $username . ",<br>We have received your account request. Here is your account validation link: <a href='https://steffalon.com/bewijzenmap/bap/p1.3/bap%20project/register.php?rcode=" . $setcode . "&id=" . $id ."'>https://steffalon.com/bewijzenmap/bap/p1.3/bap%20project/register.php</a><br><br>
                Please activate your account before 2 weeks or your account will be removed.<br><br>- SteffGram Team</p>";
                $msg .= '</html></body>';
                $headers = "From: " . "Steffgram.validator@steffalon.com" . "\r\n";
