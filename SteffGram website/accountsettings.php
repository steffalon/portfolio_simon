    ...
    <section class="note">
      ...
      <br>
        ...
        <input class="field" type="password" id="changepassword" name="changepassword" placeholder="&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;">
            <br><br>
        <button class="lbutton" onclick="location.href='index.php'" type="button"><span class="glyphicon glyphicon-arrow-left" style="width: 15px" aria-hidden="true"></span></button>
