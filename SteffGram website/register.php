...
<nav class="normal">
    <ul>
        ...
        <li style="float:right"><a class="active" href="login.php"><span class="glyphicon glyphicon-user"
                                                                         style="width: 15px" aria-hidden="true"></span>
                Login</a></li>
    </ul>
</nav>
<nav class="mobile">
...
<section class="note">
    <form method="post">
        ...
        <br><br>
        <button class="lbutton" onclick="location.href='login.php'" type="button"><span
                    class="glyphicon glyphicon-arrow-left" style="width: 15px" aria-hidden="true"></span></button>
        ...
        <section style="background-color: rgba(100, 255, 68, 0.8); border-color: white" class="note">
            <form method="post">
                ...
                <button style="width: 79.6%; background-color: rgba(100, 255, 68, 0.8); border-color: white"
                        class="lbutton" onclick="location.href='login.php'" type="button"><span
                            class="glyphicon glyphicon-arrow-left" style="width: 15px" aria-hidden="true"></span>
                </button>
                <?php endif; ?>
                <?php if ($setupcmd == '2') : ?>
                <section style="background-color: rgba(100, 255, 68, 0.8); border-color: white" class="note">
                    <form method="post">
                        ...
                        <button style="width: 79.6%; background-color: rgba(100, 255, 68, 0.8); border-color: white"
                                class="lbutton" onclick="location.href='login.php'" type="button"><span
                                    class="glyphicon glyphicon-arrow-left" style="width: 15px"
